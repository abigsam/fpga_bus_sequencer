...
set seq_ip_verif_path   [file normalize ${ip_repo_path}/bus_sequencer/verif]
set seq_ip_meminit_path [file normalize ${ip_repo_path}/bus_sequencer/mem_files]

#Aux. processes
source ${script_path}/aux_proc.tcl
source ${script_path}/make_project.tcl
source ${script_path}/make_verif.tcl
...
#Project
make_project ${seq_ip_rtl_path} ${seq_ip_meminit_path}

#Add verification
make_verif ${seq_ip_verif_path}
